...
summary: Dict[str, Any] = {
    ...
    "total_weak_days": int(np.sum(weak_days_counts)), # pyright: ignore[reportUnknownMemberType] # pyright: ignore[reportUnknownArgumentType] # pyright: ignore[reportUnknownArgumentType]
