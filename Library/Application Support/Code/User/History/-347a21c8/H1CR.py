# tests/test_model.py
from giga_atom.simulations import compute_excess_and_lambda, baseline_counts # pyright: ignore[reportUnknownVariableType]
...
def test_baseline_no_excess():
    ...
    states: List[StateLike] = compute_excess_and_lambda(counts, k=3.0) # pyright: ignore[reportUnknownVariableType]
