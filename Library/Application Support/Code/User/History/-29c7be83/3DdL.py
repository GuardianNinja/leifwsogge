...
def simulate_deposition( # pyright: ignore[reportUnknownParameterType]
    ...
    for _ in range(steps):
        ...
        sediment = np.roll( # pyright: ignore[reportUnknownVariableType] # pyright: ignore[reportUnknownMemberType] # pyright: ignore[reportUnknownMemberType] # pyright: ignore[reportUnknownMemberType]
            sediment,
            shift=shift,
            axis=(0, 1)
        )
