...
# -------------------------
# Pre-allocate arrays
lambda_all: np.ndarray = np.zeros((N_TRIALS, DAYS), dtype=float)  # type: ignore[assignment]
...
weak_days_counts = np.zeros(N_TRIALS, dtype=int) # pyright: ignore[reportUnknownMemberType, reportUnknownVariableType]
failure_flags = np.zeros(N_TRIALS, dtype=bool) # pyright: ignore[reportUnknownVariableType, reportUnknownMemberType]
...
# -------------------------
lambda_mean = np.mean(lambda_all) # pyright: ignore[reportUnknownVariableType, reportUnknownMemberType]
lambda_mean: float = float(lambda_mean)  # type: ignore[assignment, reportUnknownMemberType]
lambda_std = np.std(lambda_all) # pyright: ignore[reportUnknownVariableType, reportUnknownMemberType]
lambda_std: float  # type: ignore[assignment]
lambda_min = np.min(lambda_all) # pyright: ignore[reportUnknownVariableType, reportUnknownMemberType]
lambda_min: float  # type: ignore[assignment]
lambda_max = np.max(lambda_all) # pyright: ignore[reportUnknownVariableType, reportUnknownMemberType]
...
summary: Dict[str, Any] = {
    ...
    "total_desat_events": int(np.sum(desat_counts)), # pyright: ignore[reportUnknownMemberType] # pyright: ignore[reportUnknownArgumentType] # pyright: ignore[reportUnknownArgumentType] # type: ignore
    "total_weak_days": int(np.sum(np.asarray(weak_days_counts))), # pyright: ignore[reportUnknownMemberType] # type: ignore
    "failures": int(np.sum(np.asarray(failure_flags))), # pyright: ignore[reportUnknownMemberType] # type: ignore
}
