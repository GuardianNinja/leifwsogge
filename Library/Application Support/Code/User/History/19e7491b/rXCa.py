...
class TestPlayground(unittest.TestCase):
    ...
    def test_demo_registration(self):
        ...
        demo_registration: (str) -> RegistrationResult = self.playground.demo_registration  # type: ignore[assignment]
    ...
    def test_demo_login(self):
        ...
        _ = cast(Dict[str, Any], self.playground.demo_registration("test_user_2"))
    ...
    def test_custom_experiment(self):
        ...
        from typing import Dict, Any, Callable, List, TypedDict, cast
        class StepDict(TypedDict, total=False):
            action: str
            [key: str]: Any
        class CustomExperimentResult(TypedDict):
            experiment: str
            steps: List[StepDict]
        custom_experiment: Callable[[str, str, str, bool], CustomExperimentResult] = self.playground.custom_experiment  # type: ignore[assignment]
        result: CustomExperimentResult = cast(CustomExperimentResult, custom_experiment(
            user_id="custom_user",
        ...
        actions: List[str] = [step["action"] for step in steps if isinstance(step, dict) and "action" in step]
