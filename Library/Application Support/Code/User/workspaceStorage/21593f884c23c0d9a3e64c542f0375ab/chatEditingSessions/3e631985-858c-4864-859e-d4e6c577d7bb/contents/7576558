...
class TestSecuredFirewall(unittest.TestCase):
    ...
    def test_full_auth_and_access_flow(self):
        ...
        login1: Dict[str, Any] = login_step1("bob", "securePass123", "LINEAGE_SAFE_BOB_001")  # type: Dict[str, Any]
        ...
        from typing import Dict, Any
        access: Dict[str, Any] = self.sf.access_firewall(session_token=session, network="internet", metadata=None)  # type: Dict[str, Any]
