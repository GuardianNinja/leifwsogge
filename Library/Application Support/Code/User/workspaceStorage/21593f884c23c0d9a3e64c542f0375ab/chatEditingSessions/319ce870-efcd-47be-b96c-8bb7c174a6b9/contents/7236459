...
class TestPlaygroundSession(unittest.TestCase):
    ...
    def test_session_creation(self):
        ...
        commands_history: list[Any] = session.commands_history
...
class TestPlayground(unittest.TestCase):
    ...
    def test_demo_registration(self):
        ...
        result: RegistrationResult = cast(RegistrationResult, self.playground.demo_registration("test_user_1"))
    ...
    def test_demo_login(self):
        ...
        self.assertEqual(result_dict["demo"], "login")
        self.assertIn("step1_status", result_dict)
        self.assertIn("step2_status", result_dict)
        self.assertEqual(result_dict["step2_status"], "ok")
        self.assertIsNotNone(result_dict.get("session_token"))
    ...
    def test_demo_firewall_access(self):
        ...
        # Access firewall
        from typing import Dict, Any, cast
        result = cast(Dict[str, Any], self.playground.demo_firewall_access("test_user_3"))
    ...
    def test_tutorial_flow(self):
        ...
        from typing import Dict, Any, cast
        # Start tutorial
        start = cast(Dict[str, Any], self.playground.start_tutorial())  # type: ignore[no-untyped-call]
        self.assertEqual(start["step"], 1)
        self.assertEqual(self.playground.tutorial_step, 1)

        # Step 1: Registration
        step1: Dict[str, Any] = cast(Dict[str, Any], self.playground.tutorial_next())
        ...
        step3: Dict[str, Any] = cast(Dict[str, Any], self.playground.tutorial_next())
        self.assertEqual(step3["demo"], "firewall_access")
        self.assertEqual(self.playground.tutorial_step, 4)

        # Step 4: Intrusion Detection
        step4: Dict[str, Any] = cast(Dict[str, Any], self.playground.tutorial_next())
    ...
    def test_get_help(self):
        ...
        from typing import Dict, Any, cast
        help_info = cast(Dict[str, Any], self.playground.get_help())
