...
class TestSecuredFirewall(unittest.TestCase):
    ...
    def test_full_auth_and_access_flow(self):
        ...
        reg = self.sf.register_user("bob", "securePass123", "LINEAGE_SAFE_BOB_001")  # type: Dict[str, Any]
    ...
    def test_intrusion_attempt(self):
        ...
        res2: Dict[str, Any] = self.sf.intrude_attempt("hacker", "malicious_payload")
        status2: str = res2.get("status", "")
        message2: str = res2.get("message", "")
        self.assertEqual(status2, "trapped")
        self.assertIn("WARNING 2", message2)

        res3: Dict[str, Any] = self.sf.intrude_attempt("hacker", "malicious_payload")
        ...
        res4: Dict[str, Any] = self.sf.intrude_attempt("hacker", "malicious_payload")
