...
class TestPlayground(unittest.TestCase):
    ...
    def test_custom_experiment_without_intrusion(self):
        ...
        actions = [step["action"] for step in result["steps"] if isinstance(step, dict)]
        actions_typed: List[str] = cast(List[str], actions)
        self.assertNotIn("intrusion_test", actions_typed)
