from flask import Flask as FlaskType, request, jsonify  # type: ignore[reportUnknownVariableType]
import math
import hashlib
import numpy as np
...
def time_dilation():
    ...
    # New Dummies inputs
    mayan_doodle_raw = data.get('mayan_doodle')
    mayan_doodle: str | None = str(mayan_doodle_raw) if mayan_doodle_raw is not None else None
