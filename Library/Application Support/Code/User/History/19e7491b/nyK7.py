...
class TestPlayground(unittest.TestCase):
    ...
    def test_demo_registration(self):
        ...
        result: Dict[str, Any] = self.playground.demo_registration("test_user_1")
    ...
    def test_tutorial_flow(self):
        ...
        from typing import Dict, Any
        step4: Dict[str, Any] = self.playground.tutorial_next()
    ...
    def test_custom_experiment(self):
        ...
        class CustomExperimentResult(TypedDict, total=False):
            experiment: str
            steps: List[StepDict]
            [key: str]: Any

        result: CustomExperimentResult = self.playground.custom_experiment(
            user_id="custom_user",
        ...
        steps: List[StepDict] = result["steps"]
        actions: List[str] = [step["action"] for step in steps]
    ...
    def test_isolated_mode(self):
        ...
        from typing import Dict, Any, cast
        _ = cast(Dict[str, Any], playground.demo_registration("temp_user"))
